...
volatile eth_stats_t eth_stats;
...
volatile static int readframesizecount = 0;
...
uint16_t NCMEthernet::sendFrame(struct pbuf *p) {
	...
	eth_stats.xmit_enqueued++;
	/*xmitpkgcount++;
	if (xmitpkgcount >= 100) {
		Serial1.println("tx queue ok");
		xmitpkgcount = 0;
	}*/
